...
class PoliceOfficer(Base):
    ...
    cases = relationship("Cases", back_populates="officer")
...
class Criminal(Base):
    ...
    cases = relationship("Cases", back_populates="criminal")
...
class Cases(Base):
    ...
    court = relationship("Court", back_populates="case")
...
class Court(Base):
    ...
    case = relationship("Cases", back_populates="court")
    punishment = relationship("Punishment", back_populates="court")
